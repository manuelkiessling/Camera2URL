...
final class AppViewModel: NSObject, ObservableObject {
    ...
    @Published var showingConfigSheet: Bool = true
    ...
    private func handleTimerCapture(photoData: Data, image: UIImage) {
    ...
    private func upload(photoData: Data, image: UIImage) {
        guard let config = currentConfig else { return }
